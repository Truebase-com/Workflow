...
{
	export type BasicSourceMapConsumer = import("source-map").BasicSourceMapConsumer;
	export type BasicSourceMapConsumerConstructor = import("source-map").BasicSourceMapConsumerConstructor;
	export type IndexedSourceMapConsumer = import("source-map").IndexedSourceMapConsumer;
	export type IndexedSourceMapConsumerConstructor = import("source-map").IndexedSourceMapConsumerConstructor;
	export type MappedPosition = import("source-map").MappedPosition;
	export type Mapping = import("source-map").Mapping;
	export type MappingItem = import("source-map").MappingItem;
	export type NullableMappedPosition = import("source-map").NullableMappedPosition;
	export type NullablePosition = import("source-map").NullablePosition;
	export type Position = import("source-map").Position;
	export type RawIndexMap = import("source-map").RawIndexMap;
	export type RawSection = import("source-map").RawSection;
	export type RawSourceMap = import("source-map").RawSourceMap;
	export type SourceMapConsumer = import("source-map").SourceMapConsumer;
	export type SourceMapConsumerConstructor = import("source-map").SourceMapConsumerConstructor;
	export type SourceMapGenerator = import("source-map").SourceMapGenerator;
	export type SourceMapUrl = import("source-map").SourceMapUrl;
	export type SourceNode = import("source-map").SourceNode;
	export type StartOfSourceMap = import("source-map").StartOfSourceMap;
}

namespace Moduless
{
	export const SourceMap = require("source-map") as typeof import("source-map");
}
